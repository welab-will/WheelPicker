...
public class ScrollerLayout3 extends ViewGroup {
	...
	public ScrollerLayout3(Context context) {
		super(context);
		init();
	}
	...
	public ScrollerLayout3(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
		init();
	}

	@SuppressLint("NewApi")
	public ScrollerLayout3(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//				scrollBy(mLastX - (int) event.getRawX(), 0);
				//当前view的移动，类似于侧滑
				offsetLeftAndRight(mLastX - (int) event.getRawX());
